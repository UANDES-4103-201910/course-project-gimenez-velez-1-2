...
class GeofencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create geofence" do
    assert_difference('Geofence.count') do
      post geofences_url, params: { geofence: { area: @geofence.area, country: @geofence.country } }
    end
  ...
  test "should update geofence" do
    patch geofence_url(@geofence), params: { geofence: { area: @geofence.area, country: @geofence.country } }
